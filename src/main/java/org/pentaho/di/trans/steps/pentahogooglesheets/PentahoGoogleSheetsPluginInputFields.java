 ...
 *
 */
public class PentahoGoogleSheetsPluginInputFields implements Cloneable, TextFileInputFieldInterface {
  ...
  public PentahoGoogleSheetsPluginInputFields( String fieldname, int position, int length ) {
    this.name = fieldname;
  ...
  public PentahoGoogleSheetsPluginInputFields() {
    this( null, -1, -1 );
  }

  public int compare( Object obj ) {
    PentahoGoogleSheetsPluginInputFields field = (PentahoGoogleSheetsPluginInputFields) obj;
  ...
  public TextFileInputFieldInterface createNewInstance( String newFieldname, int x, int newlength ) {
    return new PentahoGoogleSheetsPluginInputFields( newFieldname, x, newlength );
  }
}